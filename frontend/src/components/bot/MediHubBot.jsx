...
function MediHubBot() {
  ...
  const API_KEY = "AIzaSyAK8dMqEnoPtBNxXY2JHORe-h44bT80qgA";
  ...
  return (
    <div
      className={`flex flex-col fixed bottom-24  left-10 h-[70vh] w-[18.5rem] p-4 shadow-md shadow-emerald-200  bg-white rounded-t-lg rounded-r-lg`}
    >
